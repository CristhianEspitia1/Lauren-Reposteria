...
console.log('Agregando panel y scripts del carrito a inicio.html...');

let content = fs.readFileSync('html/inicio.html', 'utf8');

// 1. Agregar panel HTML si no existe
if (!content.includes('cart-panel')) {
    ...
    console.log('  ℹ Panel HTML ya existe');
}

// 2. Agregar scripts si no existen
if (!content.includes('cart-manager.js')) {
    ...
    console.log('  ℹ Scripts ya existen');
}

fs.writeFileSync('html/inicio.html', content, 'utf8');
console.log('✅ inicio.html completamente integrado');
