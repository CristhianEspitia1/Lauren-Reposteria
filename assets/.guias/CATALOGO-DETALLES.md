# 🎁 CATÁLOGO DE DETALLES Y CAJAS ESPECIALES
...
**Personalización:**
- El oso puede ir con corazón o rosa de chocolate (rojo o dorado)

---

## 🧸 Oso grande
**Precio:** $49.000 | Con mensaje: $53.000
...
**Personalización:**
- Con pequeño mensaje en el brownie: $53.000
- El oso puede ir con corazón o rosa de chocolate (rojo o dorado)
...
**Incluye:**
- Brownie de 4-6 porciones con Nutella o arequipe y pequeño mensaje
- Galleta de cualquier sabor (ver sección galletas)
- 6 mini alfajores rellenos de arequipe

**Personalización:**
- La decoración del brownie puede ser con corazones, estrellas, mariposas o rosas
...
**Personalización:**
- Puedes escoger el color: blanco, café, azul, verde, lila, rosado o rojo (o combinar dos)
...
**Personalización:**
- Colores disponibles: blanco, café, azul, verde, lila, rosado y rojo (puedes combinar dos)
...
## ✨ Detalle Golden (3)
**Precio:** $88.000 (galleta sencilla) | $94.000 (galleta especial)

**Incluye:**
- Mini torta vasca con mermelada o arequipe
- 3 trufas de oreo
- Galleta y 5 alfajores pequeños

**Opciones de galleta sencilla ($88.000):**
- Chips con nueces (Nutella)
- Red velvet (crema de queso)
- Cocoa (chocolate)

**Opciones de galleta especial ($94.000):**
- Pistachos (chocolate blanco)
- Chocolate blanco con mermelada de frutos rojos
- Panelita Copelia (arequipe)
...
**Nota:** Cualquier variación en el diseño de la torta puede cambiar el valor
